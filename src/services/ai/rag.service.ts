...
2. สำหรับการวินิจฉัยโรคที่น่าจะเป็น (probable_diseases) และสมุฏฐานวินิจฉัย (thai_diagnosis):
   - ให้ระบุโรคที่มีความเป็นไปได้ 1 ถึง 3 โรค โดยเรียงลำดับจากความน่าจะเป็นสูงที่สุดลงมา (พร้อมระบุระดับความเป็นไปได้ เช่น สูง, ปานกลาง, น้อย เพื่อช่วยแพทย์วินิจฉัยแยกโรค Differential Diagnosis)
...
คำเตือนสำคัญ: ห้ามใส่ข้อความเกริ่นนำ ข้อความทักทาย หรือสรุปปิดท้ายใดๆ ทั้งสิ้น ให้ตอบกลับเฉพาะ JSON object ที่สมบูรณ์ตาม Schema ด้านล่างเท่านั้น เริ่มต้นด้วย { และปิดท้ายด้วย }
{
  ...
  "probable_diseases": [
    {
      "disease_name": "ชื่อโรคแพทย์แผนไทยลำดับที่ 1 ตามคัมภีร์/ตำรา (โอกาสเป็นไปได้สูงสุด)",
      "probability_level": "สูง",
    ...
    {
      "disease_name": "ชื่อโรคแพทย์แผนไทยลำดับที่ 2 (วินิจฉัยแยกโรค หรือโรคที่มีโอกาสเป็นไปได้รองลงมา)",
      "probability_level": "ปานกลาง",
